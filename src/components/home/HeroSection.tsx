        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in">
            ...
            <h1 className="mb-6 font-display text-4xl font-bold tracking-tight text-foreground md:text-5xl lg:text-6xl">
              Quality{' '}
              <span className="text-gradient">Hardware Supplies</span>{' '}
              for Every Need
            </h1>

            <p className="mb-8 text-lg text-muted-foreground md:text-xl max-w-xl mx-auto lg:mx-0">
              Your one-stop shop for quality hardware supplies. Serving both retail and wholesale customers across Pakistan with commitment to quality.
            </p>
            ...
            <div className="mt-12 grid grid-cols-4 gap-4 border-t border-border pt-8">
              <div>
                <p className="font-display text-2xl font-bold text-foreground md:text-3xl">500+</p>
                <p className="text-sm text-muted-foreground">Products</p>
              </div>
              <div>
                <p className="font-display text-2xl font-bold text-foreground md:text-3xl">9+</p>
                <p className="text-sm text-muted-foreground">Years</p>
              </div>
              <div>
                <p className="font-display text-2xl font-bold text-foreground md:text-3xl">1K+</p>
                <p className="text-sm text-muted-foreground">Customers</p>
              </div>
              <div>
                <p className="font-display text-2xl font-bold text-foreground md:text-3xl">16</p>
            ...
            <div className="relative aspect-square max-w-lg mx-auto">
              ...
              <div className="absolute inset-16 flex items-center justify-center rounded-full bg-card shadow-xl border border-border">
                <div className="text-center p-8">
                  ...
                  <p className="font-display font-bold text-foreground">Usman Hardware</p>
                  <p className="text-sm text-muted-foreground">Quality • Trust • Service</p>
                </div>
              </div>
