        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in">
            ...
            <h1 className="mb-6 font-display text-4xl font-bold tracking-tight text-foreground md:text-5xl lg:text-6xl">
              Quality{' '}
              <span className="text-gradient">Sanitary & Bathroom</span>{' '}
              Fittings
            </h1>

            <p className="mb-8 text-lg text-muted-foreground md:text-xl max-w-xl mx-auto lg:mx-0">
              Your one-stop shop for quality sanitary ware, bathroom fittings & plumbing supplies. Serving both retail and wholesale customers across Pakistan.
            </p>
            ...
            <div className="mt-12 grid grid-cols-4 gap-4 border-t border-border pt-8">
              ...
              <div>
                <p className="font-display text-2xl font-bold text-foreground md:text-3xl">5K+</p>
                <p className="text-sm text-muted-foreground">Customers</p>
              </div>
              <div>
                <p className="font-display text-2xl font-bold text-foreground md:text-3xl">5</p>
